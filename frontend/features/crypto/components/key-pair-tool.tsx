...
import { generateKeys, getKeyStatus } from "@/features/crypto/services/crypto-service"
...
export function KeyPairTool() {
  ...
  const [result, setResult] = useState<{ fingerprint: string; message: string } | null>(null)
